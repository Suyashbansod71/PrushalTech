...
import './OurProject/projectStyle.css'
const Services = () => {
  return (
    <>
    <div className='project'>
     ...
     <h1>Data and Analytical Services</h1>
     ...
     <img src='img12.jpg' className = 'img5' alt='' width= '100%'/>
...
<div class="content-wrapper">
  ...
  <div className=' card-check'> 
    ...
    <img src='img13.jpg' className = 'img4' alt='' width= '85%'/>
    </>
  )
}
